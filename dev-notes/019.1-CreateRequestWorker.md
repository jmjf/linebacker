...
-  Configuration values for
   -  Queue names are hard coded in use cases
...
-  Currently, the event bus is specific to a module (backup request); make events know how to ser/de themselves
