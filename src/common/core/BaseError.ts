export abstract class BaseError extends Error {
	...
	public errorData: object | undefined;

	constructor(messageOrErrorData: string | object, errorData?: object) {
		// decide how to interpret parameters
		const message = typeof messageOrErrorData === 'string' ? messageOrErrorData : '';
		const errData = typeof messageOrErrorData === 'object' ? messageOrErrorData : errorData;
